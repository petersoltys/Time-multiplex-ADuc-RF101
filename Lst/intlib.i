...
int EiClr(int iEiNr)
{
  ((ADI_INTERRUPT_TypeDef *)0x40002420UL)->EICLR = 0x1UL << iEiNr;
  return 1;
}
...
int EiCfg(int iEiNr, int iEnable, int iMode)
{
  ...
  EI0CFG_A = (unsigned long)& ((ADI_INTERRUPT_TypeDef *)0x40002420UL)->EI0CFG;

  EIxCFG_A = EI0CFG_A + ((iEiNr/4)*4);    
  ...
  {     
    ...
    *pEIxCFG = *pEIxCFG & ~ulMask ; 
  }
  else 
  {
    ((ADI_INTERRUPT_TypeDef *)0x40002420UL)->EICLR = 0x1UL << iEiNr; 
    ulContent = (0x8UL | iMode) << ulOffset;  
    ulMask = 0xFUL << ulOffset;
    *pEIxCFG = (*pEIxCFG & ~ulMask) | ulContent; 
  }
  return 1;
}
...
int NmiClr()
{
  ((ADI_INTERRUPT_TypeDef *)0x40002420UL)->NMICLR = 0x1;
  return 1;
}
