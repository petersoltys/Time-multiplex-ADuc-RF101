...
{
  ((ADI_PWRCTL_TypeDef *)0x40002400UL)->PWRKEY = (0x4859 << 0 );
  ((ADI_PWRCTL_TypeDef *)0x40002400UL)->PWRKEY = (0xF27B << 0 );
  ((ADI_PWRCTL_TypeDef *)0x40002400UL)->SRAMRET = iEnable;
  return 1;
}
...
int PwrSta(void)
{
  return ((ADI_PWRCTL_TypeDef *)0x40002400UL)->PWRMOD;	
}
...
{
  if (iEnable == (0x0 << 1 )) 
    ((ADI_PWRCTL_TypeDef *)0x40002400UL)->PSMCON = 0x1;  
  else 
    ((ADI_PWRCTL_TypeDef *)0x40002400UL)->PSMCON |= (0x1 << 1 );     
  return 1;
}
...
{      
  if (iExit==(0x1 << 1 ))
    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR |= (0x1 << 1 );
  if ((iMode == (0x5 << 0 ))||(iMode == (0x6 << 0 )) )
    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR |= (0x1 << 2 );
   
  if ((iMode == (0x0 << 0 )) ||(iMode == (0x5 << 0 )) ||(iMode == (0x6 << 0 )) )
   {
     ((ADI_PWRCTL_TypeDef *)0x40002400UL)->PWRKEY = (0x4859 << 0 );
     ((ADI_PWRCTL_TypeDef *)0x40002400UL)->PWRKEY = (0xF27B << 0 );
     ((ADI_PWRCTL_TypeDef *)0x40002400UL)->PWRMOD = iMode;
   }
  else
    return 0;
  return 1;
