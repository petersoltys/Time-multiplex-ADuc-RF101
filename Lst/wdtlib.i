...
{
  int	i1;
  i1 = ((ADI_WDT_TypeDef *)0x40002580UL)->T3CON & 0x20;  
  i1 |= 0x40;                   
  i1 |= iPre;
  i1 |= iInt;
  i1 |= iPd;
  ((ADI_WDT_TypeDef *)0x40002580UL)->T3CON = i1;
  return 1;	
}
...
{
  if (iEnable == (0x0 << 5 ))
    (*(volatile unsigned long *) 0x4204B114) = 0;   
  else
    (*(volatile unsigned long *) 0x4204B114) = 1;
  return 1;
}
...
int WdtLd(int iTld)
{      
  ((ADI_WDT_TypeDef *)0x40002580UL)->T3LD= iTld;
  return 1;
}
...
int WdtVal(void)
{
  return ((ADI_WDT_TypeDef *)0x40002580UL)->T3VAL;
}
...
int WdtSta()
{
  return (((ADI_WDT_TypeDef *)0x40002580UL)->T3STA);
}
...
{
  ((ADI_WDT_TypeDef *)0x40002580UL)->T3CLRI = iSource;
  return 1;
}
