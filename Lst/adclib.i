...
int AdcPd(int iPd)
{
  if (iPd == (0x1 << 4 ))
  {
    ((ADI_ADC_TypeDef *)0x40050000UL)->ADCCFG = 0; 
    ((ADI_ADC_TypeDef *)0x40050000UL)->ADCCON = 0x90; 
  }
  else
    ((ADI_ADC_TypeDef *)0x40050000UL)->ADCCON &= 0xEF; 
  return(1);
}
...
int AdcInit(int iRefBuf, int iInt, int iDMA)
{
  ...
  i1 |= iInt;
  i1 |= iDMA;
  ((ADI_ADC_TypeDef *)0x40050000UL)->ADCCON = i1;
  return 1;
}
...
{
  int	i1; 
  i1 = ((ADI_ADC_TypeDef *)0x40050000UL)->ADCCON & 0xF0; 
  if (iMode == (0x0 << 1 )) 
  {
    ((ADI_ADC_TypeDef *)0x40050000UL)->ADCCON = i1|(0x0 << 1 )|iStart; 
  }
  else 
  {
    if (iStart == (0x1 << 0 )) 
      ((ADI_ADC_TypeDef *)0x40050000UL)->ADCCON = i1|iMode;
    else 
      ((ADI_ADC_TypeDef *)0x40050000UL)->ADCCON = i1;
  }
  return(1);
...
{ 
  ...
  if (iCal == 0)
  {
  return( ((ADI_ADC_TypeDef *)0x40050000UL)->ADCDAT>>2);
  } 
  else
...
int AdcSta(void)
{
  return( ((ADI_ADC_TypeDef *)0x40050000UL)->ADCSTA&(0x1 << 0 ));
}
...
int AdcCfg(int iChan, int iRef, int iClk, int iAcq)
{
  ...
  i1 |= iClk;
  i1 |= iAcq;
  ((ADI_ADC_TypeDef *)0x40050000UL)->ADCCFG = i1;
  return (1);
}
...
int gain_correction(int adc_result)
{
  ...
  adc_gain = ((ADI_ADC_TypeDef *)0x40050000UL)->ADCGN;         
  adc_result_temp = adc_result;    
  ...
  while (gain_count > 0)
  {
    adc_result_temp = adc_result_temp >> 1;          
    if((adc_gain & bit_pos)== bit_pos)                          
    {
...
int offset_correction(void)
{
  ...
  adc_offset = ((ADI_ADC_TypeDef *)0x40050000UL)->ADCOF; 
  adc_result = ((ADI_ADC_TypeDef *)0x40050000UL)->ADCDAT;

  if((adc_offset & 8192) == 8192)  
  {    
    ADC_reading_postOF = adc_result - (adc_offset - 8192); 
  }
  else
  {
