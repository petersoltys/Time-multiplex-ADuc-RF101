...
{
  ((ADI_RESET_TypeDef *)0x40002440UL)->RSTCLR = iSource;
  return 1;
}
...
{
  int iSta;
  iSta = ((ADI_RESET_TypeDef *)0x40002440UL)->RSTSTA;
  return iSta;
}
...
{
  int iSta;
  iSta = ((ADI_PWRCTL_TypeDef *)0x40002400UL)->SHUTDOWN;
  return iSta;
}
