...
#line 24 "..\\..\\DasLib\\DmaLib.c"



DmaDesc dmaChanDesc     [16 * 2] __attribute__ ((aligned (0x200)));      
...
{  	 
   ...
   ((ADI_DMA_TypeDef *)0x40010000UL)->DMAPDBPTR = (unsigned int)&dmaChanDesc; 
   ((ADI_DMA_TypeDef *)0x40010000UL)->DMACFG = 1;                             
   return 1;	
}
...
int DmaChanSetup (unsigned int iChan, unsigned char iEnable, int iPriority)
{
  if (iEnable)
  {
    ((ADI_DMA_TypeDef *)0x40010000UL)->DMARMSKCLR = (0x1 << iChan ); 
    ((ADI_DMA_TypeDef *)0x40010000UL)->DMAENSET = (0x1 << iChan );  
    ((ADI_DMA_TypeDef *)0x40010000UL)->DMAPRISET = (0x1 << iChan ); 
  }
  else
  {
    ((ADI_DMA_TypeDef *)0x40010000UL)->DMARMSKSET = (0x1 << iChan ); 
    ((ADI_DMA_TypeDef *)0x40010000UL)->DMAENCLR = (0x1 << iChan );
    ((ADI_DMA_TypeDef *)0x40010000UL)->DMAPRICLR = (0x1 << iChan ); 
  }
 return (1);
}
...
int DmaTransferSetup(int iChan, int iNumVals, unsigned char *pucDMA)
{
  ...
  case 0:  
    ...
    Desc.destEndPtr   = (unsigned int)(&((ADI_SPI_TypeDef *)0x40004400UL)->SPITX);
    Desc.ctrlCfgVal = 0xC0000001 + ((iNumVals - 0x1) << 4);
    break;		 
  case 1:   
    Desc.srcEndPtr    = (unsigned int)(&((ADI_SPI_TypeDef *)0x40004400UL)->SPIRX); 
    Desc.destEndPtr   = (unsigned int)(pucDMA + iNumVals - 0x1); 
    Desc.ctrlCfgVal = 0x0C000001 + ((iNumVals - 0x1) << 4);
    break;  
  case 2:  
    Desc.srcEndPtr    = (unsigned int)(pucDMA + iNumVals - 0x1);	    
    Desc.destEndPtr   = (unsigned int)(&((ADI_UART_TypeDef *)0x40005000UL)->COMTX);		 	 		
    Desc.ctrlCfgVal = 0xC0000001 + ((iNumVals - 0x1) << 4);
    break;  
  case 3: 
    Desc.srcEndPtr    = (unsigned int)(&((ADI_UART_TypeDef *)0x40005000UL)->COMRX);	    
    Desc.destEndPtr   = (unsigned int)(pucDMA + iNumVals - 0x1);		 	 		
    Desc.ctrlCfgVal = 0x0C000001 + ((iNumVals - 0x1) << 4);
    break;  
  case 4:  
    Desc.srcEndPtr    = (unsigned int)(pucDMA + iNumVals - 0x1);	      
    Desc.destEndPtr   = (unsigned int)(&((ADI_I2C_TypeDef *)0x40003000UL)->I2CSTX);
    Desc.ctrlCfgVal = 0xC0000001 + ((iNumVals - 0x1) << 4);
    break;			 	
  case 5:  
    Desc.srcEndPtr    = (unsigned int)(&((ADI_I2C_TypeDef *)0x40003000UL)->I2CSRX);	      
    Desc.destEndPtr   = (unsigned int)(pucDMA + iNumVals - 0x1);
    Desc.ctrlCfgVal = 0x0C000001 + ((iNumVals - 0x1) << 4);
    break;			 	
  case 6:  
    Desc.srcEndPtr    = (unsigned int)(pucDMA + iNumVals - 0x1);
    Desc.destEndPtr   = (unsigned int)(&((ADI_I2C_TypeDef *)0x40003000UL)->I2CMTX);
    Desc.ctrlCfgVal = 0xC0000001 + ((iNumVals - 0x1) << 4);
    break;
  case 7:  
    Desc.srcEndPtr    = (unsigned int)(&((ADI_I2C_TypeDef *)0x40003000UL)->I2CMRX);
    Desc.destEndPtr   = (unsigned int)(pucDMA + iNumVals - 0x1);
    Desc.ctrlCfgVal = 0x0C000001 + ((iNumVals - 0x1) << 4);
    break;
  case 11: 
    Desc.srcEndPtr    = (unsigned int)(&((ADI_ADC_TypeDef *)0x40050000UL)->ADCDAT);  
    Desc.destEndPtr   = (unsigned int)(pucDMA + 2 * (iNumVals - 0x1));
    Desc.ctrlCfgVal = 0x5D000001 + ((iNumVals - 0x1) << 4);
    break;
  case 12: 
    Desc.srcEndPtr    = (unsigned int)(pucDMA + iNumVals - 0x1);  
    Desc.destEndPtr   = (unsigned int)(&((ADI_SPI_TypeDef *)0x40004000UL)->SPITX);
    Desc.ctrlCfgVal = 0xC0000001 + ((iNumVals - 0x1) << 4);
    break;		 		 
  case 13:  
    Desc.srcEndPtr    = (unsigned int)(&((ADI_SPI_TypeDef *)0x40004000UL)->SPIRX); 
    Desc.destEndPtr   = (unsigned int)(pucDMA + iNumVals - 0x1); 
    Desc.ctrlCfgVal = 0x0C000001 + ((iNumVals - 0x1) << 4);
    break;   
  default:	 
