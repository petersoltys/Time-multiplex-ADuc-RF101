...
typedef struct
{
    unsigned char interrupt_mask_0_r;           
    unsigned char cfg_101_r;                    
    unsigned char cfg_102_r;                    
    unsigned char cfg_103_r;                    
    unsigned char cfg_104_r;                    
    unsigned char cfg_105_r;                    
    unsigned char cfg_106_r;                    
    unsigned char cfg_107_r;                    
    unsigned char cfg_108_r;                    
    unsigned char channel_freq_0_r;             
    unsigned char channel_freq_1_r;             
    unsigned char channel_freq_2_r;             
    unsigned char cfg_10C_r;                    
    unsigned char cfg_10D_r;                    
    unsigned char cfg_10E_r;                    
    unsigned char cfg_10F_r;                    
    unsigned char cfg_110_r;                    
    unsigned char cfg_111_r;                    
    unsigned char cfg_112_r;                    
    unsigned char cfg_113_r;                    
    unsigned char radio_cfg_8_r;                
    unsigned char radio_cfg_9_r;                
    unsigned char cfg_116_r;                    
    unsigned char cfg_117_r;                    
    unsigned char image_reject_cal_phase_r;     
    unsigned char image_reject_cal_amplitude_r; 
    unsigned char cfg_11A_r;                    
    unsigned char cfg_11B_r;                    
    unsigned char symbol_mode_r;                
    unsigned char cfg_11D_r;                    
    unsigned char cfg_11E_r;                    
    unsigned char cfg_11F_r;                    
    unsigned char cfg_120_r;                    
    unsigned char cfg_121_r;                    
    unsigned char cfg_122_r;                    
    unsigned char cfg_123_r;                    
    unsigned char tx_base_adr_r;                
    unsigned char rx_base_adr_r;                
    unsigned char packet_length_control_r;      
    unsigned char packet_length_max_r;          
    unsigned char cfg_128_r;                    
    unsigned char cfg_129_r;                    
    unsigned char cfg_12A_r;                    
    unsigned char cfg_12B_r;                    
    unsigned char cfg_12C_r;                    
    unsigned char cfg_12D_r;                    
    unsigned char cfg_12E_r;                    
    unsigned char cfg_12F_r;                    
    unsigned char cfg_130_r;                    
    unsigned char cfg_131_r;                    
    unsigned char cfg_132_r;                    
    unsigned char cfg_133_r;                    
    unsigned char cfg_134_r;                    
    unsigned char cfg_135_r;                    
    unsigned char cfg_136_r;                    
    unsigned char cfg_137_r;                    
    unsigned char cfg_138_r;                    
    unsigned char cfg_139_r;                    
    unsigned char cfg_13A_r;                    
    unsigned char cfg_13B_r;                    
    unsigned char cfg_13C_r;                    
    unsigned char cfg_13D_r;                    
    unsigned char cfg_13E_r;                    
    unsigned char cfg_13F_r;                    
...
#line 210 "..\\..\\Common\\radioeng.c"

#line 217 "..\\..\\Common\\radioeng.c"

#line 226 "..\\..\\Common\\radioeng.c"

#line 239 "..\\..\\Common\\radioeng.c"
...
static unsigned long              DataRate                      = 38400; 
static RIE_BOOL             bPacketTx                     = RIE_TRUE; 
static RIE_BOOL             bPacketRx                     = RIE_TRUE; 

const unsigned char DR_38_4kbps_Dev20kHz_Configuration[] = 
{
...
const unsigned char DR_300_0kbps_Dev75_0kHz_Configuration[] = 
{
   0x14,0x00,0x00,0x00,0x00,0x00,0x00,0x33,0x00,0x76,0x62,0x21,
...
const unsigned char DR_1_0kbps_Dev10_0kHz_Configuration[] = 
{
   0x14,0x00,0x00,0x00,0x00,0x00,0x00,0x33,0x00,0x76,0x62,0x21,
...
static RIE_Responses RadioSPIXferByte           (unsigned char           ucByte,
                                                 unsigned char *         pData);
static RIE_Responses RadioSendCommandBytes      (unsigned char *         pCmdBytes,
...
static RIE_Responses RadioMMapRead              (unsigned long          ulAdr, 
                                                 unsigned long          ulLen, 
                                                 unsigned char *         pData);
static RIE_Responses RadioMMapWrite             (unsigned long          ulAdr,
                                                 unsigned long          ulLen,
                                                 unsigned char *         pData);
...
RIE_Responses RadioInit(RIE_BaseConfigs BaseConfig)
{
   ...
   ((ADI_GPIO_TypeDef *)0x40006060UL)->GPCON   =  (0x0 << 0 )  | (0x0 << 2 ) | 
                        (0x0 << 4 )  | (0x1 << 6 )     | 
                        (0x0 << 8 )      | (0x2 << 10 )     |
                        (0x1 << 12 )      | (0x0 << 14 );

   ((ADI_GPIO_TypeDef *)0x40006060UL)->GPOEN   =  (0x0 << 0 )        |  (0x0 << 1 )      |  
                        (0x0 << 2 )        |  (0x1 << 3 )     |  
                        (0x0 << 4 )        |  (0x0 << 5 )      |
                        (0x0 << 6 )        |  (0x0 << 7 );

   
   (*(volatile unsigned long *) 0x420C0D10) = 0x0;

   
   ((ADI_SPI_TypeDef *)0x40004000UL)->SPIDIV =  ((16000000/4000000)/2)-0x1;
   ((ADI_SPI_TypeDef *)0x40004000UL)->SPICON =  (0x1 << 1 )   |    
                        (0x1 << 6 )     |    
                        (0x1 << 13 )  |    
                        (0x1 << 12 )  |    
                        (0x1 << 0 );
   ...
   (((ADI_GPIO_TypeDef *)0x40006060UL)->GPSET = (0x1 << 3 ));
   ...
   ((ADI_INTERRUPT_TypeDef *)0x40002420UL)->EI2CFG = (0x3 << 0 ) | (0x1 << 3 );  
   
   
   
   ((ADI_INTERRUPT_TypeDef *)0x40002420UL)->EICLR  = (0x1 << 8 );
...
RIE_Responses RadioDeInit(void)
{
   ...
   (*(volatile unsigned long *) 0x420C0D10) = 0x1;
...
{
   RIE_Responses  Response = RIE_Success;
   unsigned long        EncodedFrequency;

   bRadioConfigurationChanged = RIE_TRUE;

   EncodedFrequency                     = (unsigned long)(Frequency * 0.00252061538);
...
{
   RIE_Responses  Response    = RIE_Success;
   unsigned char         ucNewCode;
   unsigned char         ucNewRegVal = RadioConfiguration.radio_cfg_9_r;
   ...
   if(Response == RIE_Success)
      {
      ucNewRegVal  =  ((RadioConfiguration . radio_cfg_9_r & ~(((0x1 << (3))-1) << (3))) | ucNewCode);
...
{
   RIE_Responses  Response     = RIE_Success;
   unsigned char         ucNewRegVal  = RadioConfiguration.symbol_mode_r;
...
RIE_Responses RadioTxPacketFixedLen(unsigned char Len, unsigned char *pData)
{
   ...
   if (Response == RIE_Success)
      Response = RadioToOnMode();
   if (Response == RIE_Success)
      Response = RadioMMapWrite(0x10, Len, pData);
   if (Response == RIE_Success)
      {
      RadioConfiguration.packet_length_max_r     = Len;
      RadioConfiguration.packet_length_control_r |= (0x1 << 6);
      }
   if(Response == RIE_Success)
      Response = RadioCommitRadioConfig();
   if (Response == RIE_Success)
...
RIE_Responses RadioTxPacketVariableLen(unsigned char Len, unsigned char *pData)
{
   ...
   if (Response == RIE_Success)
      Response = RadioToOnMode();
   if (Response == RIE_Success)
      Response = RadioMMapWrite(0x10, 0x1, &Len);
   if (Response == RIE_Success)
      Response = RadioMMapWrite(0x10+0x1, Len-1, pData);
   if (Response == RIE_Success)
      {
      RadioConfiguration.packet_length_max_r     = 240;
      RadioConfiguration.packet_length_control_r &= ~(0x1 << 6);
      }
   if(Response == RIE_Success)
      Response = RadioCommitRadioConfig();
...
RIE_Responses RadioTxSetPA(RIE_PATypes PAType,RIE_PAPowerLevel Power)
{
   ...
   if(Response == RIE_Success)
      ...
      switch (Power)
         ...
         case PowerLevel14:
         case PowerLevel15:
            ucNewRegVal |= ((unsigned char)Power << (3));
            
            pa_level_mcr =  (((unsigned char)Power)* 4) + 0x3;
            ...
            ucNewRegVal |= ((unsigned char)pa_ramp << (0));
            break;
         default:
            Response   = RIE_UnsupportedRadioConfig;
            break;
...
RIE_Responses RadioTxCarrier     (void)
{
   ...
   if (Response == RIE_Success)
      Response = RadioMMapWrite(0x00D,sizeof(ParamTX),&ParamTX);
   if (Response == RIE_Success)
      Response = RadioSendCommandWait(CMD_PHY_TX);
   return Response;
}
...
RIE_Responses RadioRxPacketRead(unsigned char BufferLen,unsigned char *pPktLen,unsigned char *pData,signed char *pRSSIdBm)
{
   ...
   if (RadioRxPacketAvailable())
      {
      unsigned char RdLen;
      if(RadioConfiguration.packet_length_control_r & (0x1 << 6))
         {
         if (pPktLen)
         ...
         if (RdLen > BufferLen)
            RdLen = BufferLen;
         if (Response == RIE_Success)
            Response = RadioMMapRead(0x10,RdLen, pData);
         }
      else
         {
         if (Response == RIE_Success)
            Response = RadioMMapRead(0x10,0x1, &RdLen);
         RdLen -= 0x1;
         if (pPktLen)
            *pPktLen = RdLen;
         if (RdLen > BufferLen)
            RdLen = BufferLen;
         if (Response == RIE_Success)
            Response = RadioMMapRead(0x10+0x1,RdLen, pData);
         }

      if (pRSSIdBm)
         {
         if (Response == RIE_Success)
            Response = RadioMMapRead(0x312,0x1, (unsigned char *)pRSSIdBm);
...
RIE_Responses RadioRxBERTestMode(void)
{
   ...
   ((ADI_MISC_TypeDef *)0x40008820UL)->RFTST = 0x7E1;
   ...
   Data = 0xA0;
   if (Response == RIE_Success)
      Response = RadioMMapWrite(0x3fa, 0x1, (unsigned char *)&Data);

   
   Data = 0;
   if (Response == RIE_Success)
      Response = RadioMMapWrite(0x32e,
                                0x1,
                                (unsigned char *)&Data);
   if (Response == RIE_Success)
      Response = RadioSendCommandWait(CMD_PHY_RX);
...
static RIE_Responses RadioCommitRadioConfig(void)
{
   ...
   if(bTestModeEnabled)
      ...
      Data = 0;
      if (Response == RIE_Success)
         Response = RadioMMapWrite(0x00D,sizeof(Data),&Data);
...
static RIE_Responses RadioReadState(RadioState *pState)
{
   ...
   NVIC_DisableIRQ(UHFTRX_IRQn);
   (((ADI_GPIO_TypeDef *)0x40006060UL)->GPCLR = (0x1 << 3 ));
   if (Response == RIE_Success)
      Response = RadioSPIXferByte(SPI_NOP,0);
   if (Response == RIE_Success)
      Response = RadioSPIXferByte(SPI_NOP,&StatusByte);
   (((ADI_GPIO_TypeDef *)0x40006060UL)->GPSET = (0x1 << 3 ));
   NVIC_EnableIRQ      (UHFTRX_IRQn);
   if ((Response == RIE_Success) && pState)
      *pState = (RadioState)(StatusByte & (0x1F << 0));
   return Response;
}
...
static RIE_Responses  RadioWaitForPowerUp(void)
{
   ...
   int            i        = 0x0;
   (((ADI_GPIO_TypeDef *)0x40006060UL)->GPCLR = (0x1 << 3 ));
   while (!(*(volatile unsigned long *) 0x420C0E80) && (i < 1000)) 
      i++;
   if (1000 == i)
...
void Ext_Int8_Handler (void)
{
   ...
   if (Response == RIE_Success)
      Response = RadioMMapRead(0x336,0x1, &ucInt0);
   if (Response == RIE_Success)
      Response = RadioMMapRead(0x337,0x1,&ucInt1);
   if (ucInt0 & (0x1 << 4))
      bPacketTx = RIE_TRUE;
   if (ucInt0 & (0x1 << 2))
      bPacketRx = RIE_TRUE;
   ...
   if (Response == RIE_Success)
      Response = RadioMMapWrite(0x336,0x1, &ucInt0);
   if (Response == RIE_Success)
      Response = RadioMMapWrite(0x337,0x1,&ucInt1);
...
static RIE_Responses RadioSPIXferByte(unsigned char ucByte,unsigned char *pData)
{
   RIE_Responses  Response = RIE_Success;

   ((ADI_SPI_TypeDef *)0x40004000UL)->SPITX = ucByte;  
   while((((ADI_SPI_TypeDef *)0x40004000UL)->SPISTA & (0x7 << 8 )) == 0x0);;       
   if(pData)
      *pData = ((ADI_SPI_TypeDef *)0x40004000UL)->SPIRX;
   else
      (void)((ADI_SPI_TypeDef *)0x40004000UL)->SPIRX;
   return Response;
}
...
static RIE_Responses RadioSendCommandBytes(unsigned char *pCmdBytes,unsigned char NumBytes)
{
   RIE_Responses  Response = RIE_Success;
   ...
   while ((NumBytes--) && (Response == RIE_Success))
      Response = RadioSPIXferByte(*(pCmdBytes++),0); 
   (((ADI_GPIO_TypeDef *)0x40006060UL)->GPSET = (0x1 << 3 ));   
   NVIC_EnableIRQ      (UHFTRX_IRQn);
...
static RIE_Responses RadioSendCommandNoWait (Radio_CmdCodes CmdCode )
{
   unsigned char Command = (unsigned char)CmdCode;
...
static RIE_Responses RadioMMapRead(unsigned long ulAdr, unsigned long ulLen, unsigned char *pData)
{
   RIE_Responses  Response = RIE_Success;
   ...
   if(Response == RIE_Success) 
      Response = RadioSPIXferByte(SPI_MEM_RD | ((ulAdr & 0x700) >> 8),0);
   if(Response == RIE_Success)
      Response = RadioSPIXferByte((unsigned char)(ulAdr & 0xFF),0);
   if(Response == RIE_Success)
      Response = RadioSPIXferByte((unsigned char)SPI_NOP,0);
...
static RIE_Responses RadioMMapWrite(unsigned long ulAdr,unsigned long   ulLen,unsigned char *  pData)
{
   RIE_Responses  Response = RIE_Success;
   ...
   (((ADI_GPIO_TypeDef *)0x40006060UL)->GPCLR = (0x1 << 3 ));
   if(Response == RIE_Success) 
      Response = RadioSPIXferByte(SPI_MEM_WR | ((ulAdr & 0x700) >> 8),0);
   if(Response == RIE_Success) 
      Response = RadioSPIXferByte((unsigned char)(ulAdr & 0xFF),0);
   while(ulLen-- && (Response == RIE_Success))
      Response = RadioSPIXferByte(*(pData++),0);
   (((ADI_GPIO_TypeDef *)0x40006060UL)->GPSET = (0x1 << 3 ));
   NVIC_EnableIRQ      (UHFTRX_IRQn);
...
RIE_Responses RadioConfigure (void)
{
   ...
   if(Response == RIE_Success)
      Response = RadioToOffMode();
   if(Response == RIE_Success) 
      Response = RadioMMapWrite(0x100, 
                                sizeof(TyRadioConfiguration), 
                                (unsigned char *)&RadioConfiguration);
   if(Response == RIE_Success) 
...
{
   RIE_Responses  Response     = RIE_Success;
   unsigned char         ucNewRegVal  = RadioConfiguration.radio_cfg_8_r;
   unsigned long  pa_level_mcr,pa_ramp, codes_per_bit,min_codes_per_bit;

   if (RadioConfiguration.radio_cfg_8_r & (0x1 << 7))
      ucNewRegVal  = (0x1 << 7);
   else
      ucNewRegVal  = (0x0 << 7);
   ...
   if(Response == RIE_Success)
      ...
      if (ucNewRegVal != RadioConfiguration.radio_cfg_8_r )
         ...
         if (Response == RIE_Success)
            Response = RadioMMapWrite(0x307, 0x1, (unsigned char *)&ucNewRegVal);
         RadioConfiguration.radio_cfg_8_r  = ucNewRegVal; 
         }
      }
   return Response;
