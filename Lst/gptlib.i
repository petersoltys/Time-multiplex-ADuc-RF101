...
#line 26 "..\\..\\DasLib\\GptLib.c"
#line 27 "..\\..\\DasLib\\GptLib.c"
...
{
  if (pTMR == ((ADI_TIMER_TypeDef *)0x40000000UL)) return (*(volatile unsigned long *) 0x42000398);
  else return (*(volatile unsigned long *) 0x42008398);
}
