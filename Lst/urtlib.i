...
int UrtLinCfg(int iChan, int iBaud, int iBits, int iFormat)
	...
	((ADI_UART_TypeDef *)0x40005000UL)->COMDIV = i1;
	((ADI_UART_TypeDef *)0x40005000UL)->COMFBR = 0x8800|(((((2048/32)*16000000)/i1)/iBaud)-2048);
	((ADI_UART_TypeDef *)0x40005000UL)->COMIEN = 0;
	((ADI_UART_TypeDef *)0x40005000UL)->COMLCR = (iFormat&0x7c)|(iBits&3);
	return	((ADI_UART_TypeDef *)0x40005000UL)->COMLSR;
	}
...
{
    ((ADI_UART_TypeDef *)0x40005000UL)->COMTX = iTx;
    return 1;
}
...
int UrtRx(int iChan)
{
  return ((ADI_UART_TypeDef *)0x40005000UL)->COMRX&0xff;
}
...
{
   ((ADI_UART_TypeDef *)0x40005000UL)->COMIEN = iIrq;
   return 1;
}
...
{
   return ((ADI_UART_TypeDef *)0x40005000UL)->COMIIR;
}
...
{
  if(iWr)	
    ((ADI_UART_TypeDef *)0x40005000UL)->COMMCR = iMcr;  
  return ((ADI_UART_TypeDef *)0x40005000UL)->COMMSR&0x0ff;
}
...
{
  return ((ADI_UART_TypeDef *)0x40005000UL)->COMMSR;
}
...
{
  int	i1;
  i1 = ((ADI_UART_TypeDef *)0x40005000UL)->COMIEN & ~(0x1 << 4 ) & ~(0x1 << 5 ); 
  i1 |= iDmaSel;
  ((ADI_UART_TypeDef *)0x40005000UL)->COMIEN = i1;
  return 1;
}
...
{
  if (iBrk == 0)
    ((ADI_UART_TypeDef *)0x40005000UL)->COMLCR &= 0x3F;				  
  else
    ((ADI_UART_TypeDef *)0x40005000UL)->COMLCR |= 0x40;				  
  return ((ADI_UART_TypeDef *)0x40005000UL)->COMLSR;
}
