#line 1 "..\\..\\Common\\system_ADuCRF101.c"
...
#line 26 "..\\..\\Common\\system_ADuCRF101.c"
...
#line 27 "..\\..\\Common\\system_ADuCRF101.c"
...
void SystemCoreClockUpdate (void)             
{
    ...
    switch (((ADI_CLKCTL_TypeDef *)0x40002000UL)->CLKCON & (0x3 << 3 ) ) {
    ...
    uClkDiv = uClk / (1 << (((ADI_CLKCTL_TypeDef *)0x40002000UL)->CLKCON & (0x7 << 0 )) );
...
void SystemInit (void)
{
   ...
   ((ADI_CLKCTL_TypeDef *)0x40002000UL)->CLKCON = 0x0;

    
   ((ADI_CLKCTL_TypeDef *)0x40002000UL)->XOSCCON = 0x0;
...
void SystemSetClockDivider(uint16_t div)
{
    ...
    ((ADI_CLKCTL_TypeDef *)0x40002000UL)->CLKCON &= ~((0x7 << 0 ));    
    ((ADI_CLKCTL_TypeDef *)0x40002000UL)->CLKCON |= div;   
