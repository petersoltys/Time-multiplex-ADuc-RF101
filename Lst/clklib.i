...
{
  int	i1;
  (*(volatile unsigned long *) 0x42048200) = iXosc;
  i1 = iCd;
  i1 |= iClkScr;
  i1 |= iClkOut;
  ((ADI_CLKCTL_TypeDef *)0x40002000UL)->CLKCON = i1;
  return 1;	
}
...
{
  if (iMode)
    ((ADI_CLKCTL_TypeDef *)0x40002000UL)->CLKACT = ~iClk;
  else
    ((ADI_CLKCTL_TypeDef *)0x40002000UL)->CLKPD = iClk;      
  return 1;	
}
...
int PerClkAct(int iEnable, int iClk)
{
  if (iEnable)
    ...
    ((ADI_CLKCTL_TypeDef *)0x40002000UL)->CLKACT &= (0xFFF - iClk); 
  return 1;	
...
{      
  if (iEnable)
    ...
    ((ADI_CLKCTL_TypeDef *)0x40002000UL)->CLKPD &= (0xFFF - iClk); 
  return 1;	
}
